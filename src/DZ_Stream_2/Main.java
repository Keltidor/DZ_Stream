...
public class Main {
    public static void main(String[] args) {
        ...
        long count = persons.stream().
                ...
                count();
        System.out.println("Количество несовершеннолетних человек: " + count + "\n");
        ...
        List<String> worker = persons.stream()
                ...
                .filter(y -> y.getEducation() == Education.HIGHER)
                .filter(s -> s.getSex() == Sex.MAN && s.getAge() < 60 || s.getSex() == Sex.WOMAN && s.getAge() < 65)
                .limit(30)
